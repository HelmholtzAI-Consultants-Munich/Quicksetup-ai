...
Welcome to ``ML-Pipeline-Template`` contributor's guide.
...
If you experience bugs or general issues with ``ML-Pipeline-Template``, please have a look
...
You can help improve ``ML-Pipeline-Template`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``ML-Pipeline-Template`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``ML-Pipeline-Template``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n ML-Pipeline-Template python=3 six virtualenv pytest pytest-cov
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/ML-Pipeline-Template.git
...
#. Install |pre-commit|_::
   ...
   ``ML-Pipeline-Template`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/ML-Pipeline-Template
.. _issue tracker: https://github.com/<USERNAME>/ML-Pipeline-Template/issues
.. <-- end -->
